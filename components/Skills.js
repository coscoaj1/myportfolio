...
function Skills() {
  return (
    <div className="w-full h-auto bg-[#111128] py-6 mt-6">
      <p className="w-full text-4xl text-center font-medium text-gray-200">
        Skills
      </p>
      <div className="flex flex-col flex-wrap md:flex-row justify-center items-center max-w-screen mt-8 mb-24 sm:w-full h-auto w-full gap-8">
        ...
        <div>
          <div className="flex flex-col items-center justify-center bg-[#fafafa] w-96 h-96 rounded-xl mx-4">
            <div className="pt-8">
