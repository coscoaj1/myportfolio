...
function Skills() {
	return (
		<div className="w-full h-auto bg-[#111828] py-6">
			...
			<div className="flex flex-col flex-wrap md:flex-row justify-center items-center max-w-screen mt-8 mb-24 sm:w-full h-auto w-full gap-8">
				...
				<div className="flex-[basis:33%]">
					<div className="grid place-items-center bg-[#fafafa] border w-96 h-60 rounded-xl">
						<div className="p-4">
							<Image
				...
				<div className="flex-[basis:33%]">
					<div>
						<div className=" flex flex-col items-center justify-center bg-[#fafafa] w-96 h-60 rounded-xl">
							<div>
								<Image src="/icons/nodejs-1.svg" width={180} height={125} />
							</div>
							<div className="">
