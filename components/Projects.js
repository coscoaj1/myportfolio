...
function Projects({ handleClick }) {
	...
	return (
		<div className="max-w-screen bg-[#111828]">
			<div
				id="projects"
				className="mt-3 pt-3 text-5xl text-center text-[#828cf8] font-medium bg-[#111828]"
			>
				Projects
			</div>
			<section className="bg-[#111828] flex flex-col justify-center items-center sm:h-auto w-screen">
				<Project
					onClick={handleClick}
