		...
		>
			...
			<div className="flex flex-col items-center justify-center w-full">
				...
				<div className="z-10 flex flex-col items-center justify-center">
					<p className="px-2 my-8 text-xl leading-relaxed text-center text-gray-100 max-w-4xl sm:w-2/3">
						...
						Asheville, NC. I can find creative solutions{' '}
						<span className="text-[#808af9]">to complex problems</span> for your
						company, and am willing and eager to learn{' '}
